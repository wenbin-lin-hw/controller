...
class Controller:
    def __init__(self, robot):        
        ...
        self.AVOIDANCE_DURATION = 15  # Reduced: steps to move around obstacle
        self.SEARCH_DURATION = 80  # Reduced: steps to search for line
